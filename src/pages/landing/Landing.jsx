...
const Landing = () => {
    ...
    return(
            <React.Fragment>
                <div className={`${open ? styles.list__button_open : ''} ${styles.list__button}`} onClick={clickHam}>
                ...
                <div className={ home === true ? `${styles.container}` : `${styles.container} ${styles.container__active}`}>
                    ...
                    <h2 className={ `${styles.heading2} ${home === true ? "" : styles.heading2__active}` }> A <span>Software Developer</span> with An Enthusiastic Attitude</h2>
                    <ul className={ `${home === true ? "" : styles.listContainer__active} ${open === true ? styles.listContainer__open : '' } ${styles.listContainer}`}>
                        ...
                        <li className={` ${styles.list} ${styles.list__5} ${home === true ? "" : styles.list__active} ` }>
